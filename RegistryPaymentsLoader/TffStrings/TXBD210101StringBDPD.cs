...
namespace RegistryPaymentsLoader.TffStrings
{
    public class TXBD210101StringBDPD : TffStringBD
    {
        ...
        public override KumiPayment ToPayment()
        {
            ...
            {
                Guid = tffStringParts[45] == "" ? null : tffStringParts[45],
                IdSource = 2, // BDPD
                ...
                Purpose = tffStringParts[29] == "" ? null : tffStringParts[29],
                Kbk = tffStringParts[31] == "" ? null : tffStringParts[31],
