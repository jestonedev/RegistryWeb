...
{
    public class OwnershipPremisesAssocConfiguration : IEntityTypeConfiguration<OwnershipPremisesAssoc>
    {
        private string nameDatebase;

        public OwnershipPremisesAssocConfiguration(string nameDatebase)
        {
            this.nameDatebase = nameDatebase;
        }

        public void Configure(EntityTypeBuilder<OwnershipPremisesAssoc> builder)
        {
