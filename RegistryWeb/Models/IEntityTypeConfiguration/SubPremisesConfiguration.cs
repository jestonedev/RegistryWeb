...
{
    public class SubPremisesConfiguration : IEntityTypeConfiguration<SubPremises>
    {
        private string nameDatebase;

        public SubPremisesConfiguration(string nameDatebase)
        {
            this.nameDatebase = nameDatebase;
        }

        public void Configure(EntityTypeBuilder<SubPremises> builder)
        {
