...
{
    public class OwnerSubPremisesAssocConfiguration : IEntityTypeConfiguration<OwnerSubPremisesAssoc>
    {
        private string nameDatebase;

        public OwnerSubPremisesAssocConfiguration(string nameDatebase)
        {
            this.nameDatebase = nameDatebase;
        }

        public void Configure(EntityTypeBuilder<OwnerSubPremisesAssoc> builder)
        {
