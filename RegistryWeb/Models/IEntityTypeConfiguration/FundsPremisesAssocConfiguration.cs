...
{
    public class FundsPremisesAssocConfiguration : IEntityTypeConfiguration<FundsPremisesAssoc>
    {
        private string nameDatebase;

        public FundsPremisesAssocConfiguration(string nameDatebase)
        {
            this.nameDatebase = nameDatebase;
        }

        public void Configure(EntityTypeBuilder<FundsPremisesAssoc> builder)
        {
