...
{
    public class OwnerPremisesAssocConfiguration : IEntityTypeConfiguration<OwnerPremisesAssoc>
    {
        private string nameDatebase;

        public OwnerPremisesAssocConfiguration(string nameDatebase)
        {
            this.nameDatebase = nameDatebase;
        }

        public void Configure(EntityTypeBuilder<OwnerPremisesAssoc> builder)
        {
