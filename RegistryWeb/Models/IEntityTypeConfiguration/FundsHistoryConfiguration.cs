...
{
    public class FundsHistoryConfiguration : IEntityTypeConfiguration<FundsHistory>
    {
        private string nameDatebase;

        public FundsHistoryConfiguration(string nameDatebase)
        {
            this.nameDatebase = nameDatebase;
        }

        public void Configure(EntityTypeBuilder<FundsHistory> builder)
        {
