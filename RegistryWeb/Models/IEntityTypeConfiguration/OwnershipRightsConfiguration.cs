...
{
    public class OwnershipRightsConfiguration : IEntityTypeConfiguration<OwnershipRights>
    {
        private string nameDatebase;

        public OwnershipRightsConfiguration(string nameDatebase)
        {
            this.nameDatebase = nameDatebase;
        }

        public void Configure(EntityTypeBuilder<OwnershipRights> builder)
        {
