...
namespace RegistryDb.Models
{
    public partial class RegistryContext : DbContext
    {
        ...
        public virtual DbSet<KumiPaymentUntied> KumiPaymentsUntied { get; set; }
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.ApplyConfiguration(new KumiPaymentUntiedConfiguration(nameDatebase));
            ...
            modelBuilder.ApplyConfiguration(new KumiKeyRateConfiguration(nameDatebase));
        }
