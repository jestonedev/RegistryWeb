...
namespace RegistryWeb.ReportServices
{
    public class PrivatizationReportService : ReportService
    {
        ...
        public byte[] GetCommonReport(PrivCommonReportSettings settings)
        {
        ...
        public byte[] GetContractorWarrant(PrivContractorWarrantReportSettings settings)
        {
            var arguments = new Dictionary<string, object> {
        ...
        public byte[] GetMonthQuarterReport(PrivQuarterReportSettings settings)
        {
            var filterField = "";
        ...
        public byte[] GetContract(PrivContractReportSettings settings)
        {
            var arguments = new Dictionary<string, object> {
